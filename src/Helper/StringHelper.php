...
class StringHelper
{
    ...
    {
        return mb_substr($string, $start, null === $length ? mb_strlen($string, '8bit') : $length, '8bit');
    }
    ...
    {
        if (null === $encoding) {
            $encoding = Eii::$app ? Eii::$app->charset : 'UTF-8';
        }
        if ($asHtml) {
    ...
    protected static function truncateHtml($string, $count, $suffix, $encoding = false)
    {
        ...
        if (null !== Eii::$app) {
            $config->set('Cache.SerializerPath', Eii::$app->getRuntimePath());
        }
    ...
    public static function normalizeNumber($value)
    {
        ...
        if (null !== $decimalSeparator && '.' !== $decimalSeparator) {
